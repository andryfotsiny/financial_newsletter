...
const latestContent = [
    ...
    },
    {
        ...
        excerpt: 'Analyse détaillée des perspectives de Tesla pour le quatrième trimestre avec focus sur les livraisons.',
...
const contentTypes = [
    {
        ...
        description: "Newsletter quotidienne envoyée chaque matin avec les points clés des marchés",
        frequency: "Quotidien"
    },
    {
        icon: TrendingUp,
        title: "Sélection de titres",
        description: "Recommandations d'investissement avec objectifs de prix et analyse risque/rendement",
        frequency: "2x/semaine"
    },
    {
        icon: PieChart,
        title: "Sélection de fonds",
        description: "Analyse et sélection des meilleurs fonds d'investissement par catégorie",
        frequency: "Hebdomadaire"
    },
    {
        icon: Globe,
        title: "Analyses macroéconomiques",
        description: "Décryptage des grandes tendances économiques et impact sur les marchés",
        frequency: "Bi-mensuel"
    },
    {
        icon: Eye,
        title: "Recherches thématiques",
        description: "Études approfondies sur les secteurs et tendances d'investissement émergentes",
        frequency: "Mensuel"
    }
]
...
const featuredReviews = [
    ...
    },
    {
        ...
        rating: 5,
        content: 'Les signaux de trading sont d\'une précision remarquable. Mes performances se sont nettement améliorées.',
        avatar: null,
                    ...
                    <div className="relative grid grid-cols-1 lg:grid-cols-4 gap-8">
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                            ...
                                            <span>•</span>
                                            <span>{formatDate(mainArticle.publishedAt, { day: 'numeric', month: 'long' })}</span>
                                            <span>•</span>
                        ...
                        <div className="lg:col-span-1 space-y-6">
                            <div className="sticky top-24">
                                <h3 className="text-lg font-semibold text-foreground mb-4">Types de recherche</h3>
                ...
                <div className="container mx-auto max-w-6xl">
                    ...
                    >
                        ...
                        <div className="flex justify-center mt-6 gap-3">
                            {partners.slice(0, Math.ceil(partners.length / partnersPerView)).map((_, index) => (
                                <button
                                    key={index}
                                    className={`w-3 h-3 rounded-full transition-all duration-300 border-2 ${
                                        Math.floor(Math.abs(translateX) / cardWidth) % Math.ceil(partners.length / partnersPerView) === index
                                            ? 'bg-primary border-primary shadow-lg scale-125'
                                            : 'bg-transparent border-primary/40 hover:border-primary/70 hover:scale-110'
                                    }`}
                                    onClick={() => setTranslateX(-index * cardWidth * partnersPerView)}
                                />
                            ))}
                        </div>
                    </div>
                ...
                <div className="container mx-auto max-w-4xl text-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Rejoignez plus de 15,000 investisseurs qui utilisent nos analyses pour prendre
                            des décisions éclairées et optimiser leurs performances.
                        </p>

                        <div className="grid md:grid-cols-3 gap-6 my-8">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-primary mb-2">7 jours</div>
                                <div className="text-sm text-muted-foreground">Essai gratuit</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-primary mb-2">29€</div>
                                <div className="text-sm text-muted-foreground">Par mois seulement</div>
                            </div>
                            <div className="text-center">
                        ...
                        {[
                            {
                                ...
                                answer: "Accès complet à toutes nos analyses, sélections de titres, newsletters quotidiennes et recherches thématiques exclusives."
                            },
                            {
                                question: "Puis-je annuler à tout moment ?",
                                answer: "Oui, vous pouvez annuler votre abonnement à tout moment depuis votre espace client. Aucun frais d'annulation."
                            },
                            {
                                question: "Comment fonctionne l'essai gratuit ?",
                                answer: "7 jours d'accès complet à toutes les fonctionnalités Premium, sans engagement ni prélèvement."
                            },
                            {
                                question: "Vos analyses conviennent-elles aux débutants ?",
                                answer: "Absolument ! Nos contenus sont adaptés à tous les niveaux avec des explications claires et pédagogiques."
                            }
                        ].map((faq, index) => (
                            <motion.div key={index} variants={fadeInUp}>
